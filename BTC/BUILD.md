...
- [x] 4. `trading/cvd_perp.csv` — Binance **futures** taker buy/sell (cumulate)  Z=-0.81 (2026-09-07)
- [x] 5. `trading/cvd_spot.csv` — Binance **spot** taker buy/sell (cumulate)  Z=-0.84 (2026-09-08)
