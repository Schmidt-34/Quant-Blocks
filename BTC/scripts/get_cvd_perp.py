#!/usr/bin/env python3
"""Pull today's Binance BTCUSDT perp taker buy/sell. Cumulate CVD.
...
OUT = ROOT / "trading" / "cvd_perp.csv"
KLINE_URL = "https://fapi.binance.com/fapi/v1/klines?symbol=BTCUSDT&interval=1d&limit=2"
...
def main() -> None:
    ...
    # USD-M kline: [5]=volume BTC, [9]=taker buy base volume BTC
    vol = float(chosen[5])
