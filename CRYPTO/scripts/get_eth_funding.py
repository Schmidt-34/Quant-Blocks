#!/usr/bin/env python3
"""Pull today's Binance ETHUSDT perp funding. Append-only to trading/eth_funding.csv.
...
OUT = ROOT / "trading" / "eth_funding.csv"
MARK_URL = "https://fapi.binance.com/fapi/v1/premiumIndex?symbol=ETHUSDT"
RATE_URL = "https://fapi.binance.com/fapi/v1/fundingRate?symbol=ETHUSDT&limit=1"
