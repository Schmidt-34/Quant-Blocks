#!/usr/bin/env python3
"""Pull today's Binance ETHUSDT perp OI. Append-only to trading/eth_oi.csv.
...
OUT = ROOT / "trading" / "eth_oi.csv"
OI_URL = "https://fapi.binance.com/fapi/v1/openInterest?symbol=ETHUSDT"
MARK_URL = "https://fapi.binance.com/fapi/v1/premiumIndex?symbol=ETHUSDT"
HIST_URL = "https://fapi.binance.com/futures/data/openInterestHist?symbol=ETHUSDT&period=1d&limit=2"
SOURCE = "fapi.binance.com ETHUSDT perp"
FIELDS = ["date", "oi_usd", "oi_24h_pct", "z", "source"]
HEADERS = {"User-Agent": "Quant-Blocks-CRYPTO/0.1"}
QMI_METRICS = Path(
    os.environ.get(
        "QMI_METRICS",
        str(
